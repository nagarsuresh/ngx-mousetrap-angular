...
export declare class NgxMousetrapDirective implements OnInit, OnDestroy {
    ...
    ngOnInit(): void;
    ngOnDestroy(): void;
    static ɵfac: ɵngcc0.ɵɵFactoryDef<NgxMousetrapDirective, never>;
    static ɵdir: ɵngcc0.ɵɵDirectiveDefWithMeta<NgxMousetrapDirective, "[ngxMousetrapKey]", never, { "ngxMousetrapKey": "ngxMousetrapKey"; "suppressAutoClick": "suppressAutoClick"; }, { "mousetrapKeyPressed": "mousetrapKeyPressed"; }, never>;
}
